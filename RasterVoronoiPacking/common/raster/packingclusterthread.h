...
public:
	...
	void setSolver(std::shared_ptr<RASTERVORONOIPACKING::RasterStripPackingSolver> _solver, std::shared_ptr<RASTERVORONOIPACKING::RasterStripPackingSolverClusterGLS> _clusterSolver) {
...
protected:
	std::shared_ptr<RASTERVORONOIPACKING::RasterStripPackingSolverClusterGLS> clusterSolver;
