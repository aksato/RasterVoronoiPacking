...
std::shared_ptr<TotalOverlapMap> RasterOverlapEvaluatorGLS::getTotalOverlapMap(int itemId, int orientation, RasterPackingSolution &solution) {
...
void RasterOverlapEvaluatorGLS::updateWeights(RasterPackingSolution &solution) {
...
void RasterOverlapEvaluatorGLS::resetWeights() {
